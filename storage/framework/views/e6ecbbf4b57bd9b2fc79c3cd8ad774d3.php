                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    class="w-full rounded-xl border border-black/15 bg-white px-3 py-3 pl-10 text-sm text-black placeholder:text-black/35 focus:border-[#2D9344] focus:outline-none focus:ring-2 focus:ring-[#2D9344]/25 <?php echo e($errors->has('email') ? 'border-[#ED1C24]' : ''); ?>"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    id="password"
                                    name="password"
                                    class="w-full rounded-xl border border-black/15 bg-white px-3 py-3 pl-10 pr-10 text-sm text-black placeholder:text-black/35 focus:border-[#2D9344] focus:outline-none focus:ring-2 focus:ring-[#2D9344]/25 <?php echo e($errors->has('password') ? 'border-[#ED1C24]' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-medium text-black hover:text-[#ED1C24] transition-colors">
                                Forgot password?
                            </a>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\GR8TECH_Payroll-master\resources\views/auth/login.blade.php ENDPATH**/ ?>