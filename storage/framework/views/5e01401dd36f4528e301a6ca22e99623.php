    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="<?php echo e(route('salary-schedule.store')); ?>" class="space-y-6">
            ...
            <div>
                ...
                <div class="space-y-4">
                    <label class="relative flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors <?php echo e(old('schedule_type') === 'semi_monthly' ? 'border-blue-500 bg-blue-50' : 'border-gray-300'); ?>">
                        <input type="radio" name="schedule_type" value="semi_monthly" <?php echo e(old('schedule_type') === 'semi_monthly' ? 'checked' : ''); ?> class="sr-only peer" required>
                    ...
                    <label class="relative flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors <?php echo e(old('schedule_type') === 'monthly' ? 'border-blue-500 bg-blue-50' : 'border-gray-300'); ?>">
                        <input type="radio" name="schedule_type" value="monthly" <?php echo e(old('schedule_type') === 'monthly' ? 'checked' : ''); ?> class="sr-only peer" required>
                        <div class="flex items-center w-full">
                            <div class="w-5 h-5 border-2 border-gray-300 rounded-full mr-3 peer-checked:border-blue-600 peer-checked:bg-blue-600"></div>
                            <div class="flex-1">
