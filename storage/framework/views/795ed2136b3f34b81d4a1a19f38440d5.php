...
<nav class="brand-sidebar-nav mt-8 px-4 pb-4">
    <div class="space-y-2">
        ...
        <a href="<?php echo e(route('salary-schedule.index')); ?>" class="flex items-center px-4 py-3 text-sm font-medium <?php echo e($activeRoute === 'salary-schedule.index' ? 'text-blue-600 bg-blue-50 border-r-4 border-blue-600' : 'text-gray-700 hover:bg-gray-50 hover:text-blue-600'); ?> rounded-lg transition-all duration-200 group">
            <i class="fas fa-calendar-alt mr-3 text-lg <?php echo e($activeRoute === 'salary-schedule.index' ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600'); ?>"></i>
...
</script><?php /**PATH C:\GR8TECH_Payroll-master\resources\views/components/dashboard/sidebar/navigation.blade.php ENDPATH**/ ?>