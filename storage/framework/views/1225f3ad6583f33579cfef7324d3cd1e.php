...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const settingsForm = document.querySelector('form[action="<?php echo e(route("hr.settings.update")); ?>"]');
    ...
    applyDarkMode(<?php echo e($userPreferences['dark_mode'] ? 'true' : 'false'); ?>);
    ...
    if (darkModeToggle) {
        darkModeToggle.addEventListener('change', function() {
            ...
            fetch('<?php echo e(route("hr.settings.update")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'hr.settings'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\GR8TECH_Payroll-master\resources\views/hr/settings.blade.php ENDPATH**/ ?>